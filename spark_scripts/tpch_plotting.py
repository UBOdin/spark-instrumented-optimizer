...
input_folder = "../tpch/tpch_output/tpch_output_"
...
plt.savefig('./final_graphs/StackedTimeTpchAvg_New.pdf',bbox_inches='tight')
plt.show()
...
plt.ylim(ymin=0)
plt.ylim(ymax=100) 
plt.savefig('./final_graphs/PercentTimeTpchAvg_New.pdf',bbox_inches='tight') 
plt.show() 
...
plt.ylim(ymin=0)
plt.ylim(ymax=100) 
plt.savefig('./final_graphs/PercentTimeTpchExecuteAvg_New.pdf',bbox_inches='tight') 
plt.show() 
