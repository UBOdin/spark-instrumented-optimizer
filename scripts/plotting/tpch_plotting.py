...
input_directory = "../timing/output/"

search_line = "stopTheClock : Explain : Total Time in Search Phase that has an exec"
noExecSearchLine = "stopTheClock : Explain : Total Time in Search Phase that doesn't have an exec"
effective_line = "stopTheClock : Explain : Total Time in Rewrite Phase Effective"
ineffective_line = "stopTheClock : Explain : Total Time in Rewrite Phase InEffective"
noExecRewrite_line = "stopTheClock : Explain : Total Time in Rewrite Phase that doesn't have an exec"
execute_line = "stopTheClock : Explain : Total Time in Execution Phase"
optimiedAstline = "stopTheClock : Explain : Optimized Plan Size :"
...
for file in os.listdir(input_directory):
    file_name = open(os.path.join(input_directory, file), "r")
    print(file_name.name)
    file_names.append(int(file.replace(".scala_output.txt", "").replace("spark_command_","")))
...
Total_Search_avg = np.sum(Total_Search, axis = 0)/5.0
Total_Ineffective_Rewrite_avg = np.sum(Total_Ineffective_Rewrite, axis = 0)/5.0
Total_Effective_Rewrite_avg = np.sum(Total_Effective_Rewrite, axis = 0)/5.0
Total_Execution_avg = np.sum(Total_Execution, axis = 0)/5.0
Total_noExec_Rewrite_avg = np.sum(Total_noExec_Rewrite, axis = 0)/5.0
Total_No_Exec_Search_avg = np.sum(Total_No_Exec_Search, axis = 0)/5.0
...
Total_Search_avg = np.array([
    Total_Search_avg,Total_Search_avg,
    Total_Search_avg,Total_Search_avg,
    Total_Search_avg,Total_Search_avg,
    Total_Search_avg,Total_Search_avg,
    Total_Search_avg,Total_Search_avg,
...
Total_No_Exec_Search_avg = np.array([
    Total_No_Exec_Search_avg,Total_No_Exec_Search_avg,
    Total_No_Exec_Search_avg,Total_No_Exec_Search_avg,
    Total_No_Exec_Search_avg,Total_No_Exec_Search_avg,
    Total_No_Exec_Search_avg,Total_No_Exec_Search_avg,
    Total_No_Exec_Search_avg,Total_No_Exec_Search_avg,
...
Total_Ineffective_Rewrite_avg = np.array([
    Total_Ineffective_Rewrite_avg,Total_Ineffective_Rewrite_avg,
    Total_Ineffective_Rewrite_avg,Total_Ineffective_Rewrite_avg,
    Total_Ineffective_Rewrite_avg,Total_Ineffective_Rewrite_avg,
    Total_Ineffective_Rewrite_avg,Total_Ineffective_Rewrite_avg,
    Total_Ineffective_Rewrite_avg,Total_Ineffective_Rewrite_avg,
...
Total_Effective_Rewrite_avg = np.array([
    Total_Effective_Rewrite_avg,Total_Effective_Rewrite_avg,
    Total_Effective_Rewrite_avg,Total_Effective_Rewrite_avg,
    Total_Effective_Rewrite_avg,Total_Effective_Rewrite_avg,
    Total_Effective_Rewrite_avg,Total_Effective_Rewrite_avg,
    Total_Effective_Rewrite_avg,Total_Effective_Rewrite_avg,
...
Total_Execution_avg = np.array([
    Total_Execution_avg,Total_Execution_avg,
    Total_Execution_avg,Total_Execution_avg,
    Total_Execution_avg,Total_Execution_avg,
    Total_Execution_avg,Total_Execution_avg,
    Total_Execution_avg,Total_Execution_avg,
...
Total_noExec_Rewrite_avg = np.array([
    Total_noExec_Rewrite_avg,Total_noExec_Rewrite_avg,
    Total_noExec_Rewrite_avg,Total_noExec_Rewrite_avg,
    Total_noExec_Rewrite_avg,Total_noExec_Rewrite_avg,
    Total_noExec_Rewrite_avg,Total_noExec_Rewrite_avg,
    Total_noExec_Rewrite_avg,Total_noExec_Rewrite_avg,
...
plt.savefig('./output/StackedTimeTpchAvg_New.pdf',bbox_inches='tight')
plt.show()
